...
-   **out** : objet de sortie qui contient le résultat de la fonction **filterAndTrim**, c'est une table récapitulant les nombres de reads avant et après le filtrage.
...
## **4) Correction des erreurs et déduction des séquences**
