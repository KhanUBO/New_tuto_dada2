...
-   **method="consensus"** : Ce paramètre de **removeBimeraDenovo** permet de vérifier chaque échantillon indépendamment pour détecter les chimères.
    Ensuite, une décision consensuelleest prise pour déterminer si une séquence est une chimère, en se basant sur l'accord entre les résultats de plusieurs échantillons.
...
Ensuite, il a fallu supprimer les noms de lignes:
